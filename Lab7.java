...
public class Lab7 extends JPanel implements GLEventListener {
	...
	private void triangularPrism(GL2 gl2) {
		// TODO: add texture coordinates - DONE
	...
	private Texture textureFromResource(String resourceName) throws IOException {
		...
		t = AWTTextureIO.newTexture(displayGL.getGLProfile(), image, true);
		
		t.setTexParameteri(gl2, GL2.GL_TEXTURE_WRAP_S, GL2.GL_REPEAT);
		
		t.setTexParameteri(gl2, GL2.GL_TEXTURE_WRAP_T, GL2.GL_REPEAT);
		return t;
	}
	...
	private Texture textureFromPainting() {
		...
		Texture t;
		t = AWTTextureIO.newTexture(displayGL.getGLProfile(), img, true);
		t.setTexParameteri(gl2, GL2.GL_TEXTURE_WRAP_S, GL2.GL_REPEAT);
		t.setTexParameteri(gl2, GL2.GL_TEXTURE_WRAP_T, GL2.GL_REPEAT);
		return t;
	}
	...
	public JMenuBar getMenuBar() {
		...
		makeMenuItem(objectMenu, "Cube", objectListener, 2);
		makeMenuItem(objectMenu, "Cylinder", objectListener, 1);
		makeMenuItem(objectMenu, "Cone", objectListener, 0);
