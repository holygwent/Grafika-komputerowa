...
public class Lab6 extends GLJPanel implements GLEventListener  {
    ...
    private void pyramid(float n,  GL2 gl2)
    {
    ...
    public void display(GLAutoDrawable drawable) {
       ...
       gl2.glPopMatrix();
//To do some shapes!!!!!!!!
      //precyzujemy kolor  rgba z³oty
       float gold[] = { 0.8549019607843137f, 0.6470588235294118f, 0.1254901960784314f, 1 };
       //nak³adamy na przedni¹ i tylni¹ powiechnie z³oty materia³ 
       gl2.glMaterialfv(gl2.GL_FRONT_AND_BACK,GLLightingFunc.GL_AMBIENT_AND_DIFFUSE, FloatBuffer.wrap(gold));
       //kolor odbicia
       float[] rozproszenie = {1,0.8431372549019608f,0,1};
       // ustawiamy kolor odbicia materia³u z przodu na jasniejszy z³oty 
       gl2.glMaterialfv(gl2.GL_FRONT,GLLightingFunc.GL_SPECULAR, FloatBuffer.wrap(rozproszenie));
    //od³ysk
       float[] shininess = {90};
       //ustawiam okreœlony odb³ysk œwiat³a z przodu
       gl2.glMaterialfv(gl2.GL_FRONT, GLLightingFunc.GL_SHININESS, FloatBuffer.wrap(shininess));
       //rysujemy piramide z lab 5
       pyramid(15,gl2);
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        gl2.glLoadIdentity();
        glu.gluPerspective(20, (double)getWidth()/ getHeight(), 4, 100);
        ...
        //ustawienie ŒWIAT£O 2 ROZPROSZONE kolor bia³y
        gl2.glLightfv(GL2.GL_LIGHT2, GL2.GL_DIFFUSE, FloatBuffer.wrap(new float[] {1,1,1}));
        //ustawienie swiat³a 2 pod¹zaj¹cego  za perspektyw¹
        gl2.glLightfv(GL2.GL_LIGHT2, GL2.GL_POSITION, FloatBuffer.wrap(new float[] {50,50,50,1}));
        //w³¹czenie 2 swiat³a
        gl2.glEnable(GL2.GL_LIGHT2);
        //ustawienie œwiat³a 3 otaczaj¹cego 
        gl2.glLightfv(GL2.GL_LIGHT3, GL2.GL_AMBIENT, FloatBuffer.wrap(new float[] {0.2f,0.2f,0.2f,1f}));
        //w³¹czenie œwiat³a 3
